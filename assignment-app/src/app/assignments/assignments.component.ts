...
export class AssignmentsComponent implements OnInit {
  ...
  assignmentss: Assignment[] = [];
  assiRendu: Assignment[] = [];
  assinonRendu: Assignment[] = [];
  ...
  ngOnInit(): void {
    try
    {
      this.assignmentsService.voir = Boolean (localStorage.getItem('voir'));
    }
    catch(e)
    {
  ...
  getAssignmentss() {
    ...
    this.assignmentsService.getAssigmentss()
    .subscribe(assignmentss => this.assignmentss = assignmentss);
  }
